# Write all Flutter source files to disk

$base = "C:\Users\chath\EduPulseAI\flutter_app\lib"
...
'@ | Set-Content "$base\core\api_service.dart" -Encoding UTF8

Write-Host "api_service.dart written"
